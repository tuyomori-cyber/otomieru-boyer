...
詳細は[全体仕様書](<specification/仕様書.md>)、[v0.3.0 音高メモ仕様書](<specification/v0.3.0 音高メモ仕様書.md>)、[v0.4.0仕様書](<specification/v0.4.0 仕様書.md>)、[テスト項目](<test/v0.4.0 テスト項目.md>)、[変更履歴](CHANGELOG.md)、[アーキテクチャ](docs/architecture.md)、[外部依存関係と同梱音源](docs/dependencies.md)を参照してください。
